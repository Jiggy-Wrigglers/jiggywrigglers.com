 ...
 * Playlist Component
 *
 * Spotify / Apple Music call-to-action band, like the old site's
 * jiggy-playlight-footer. Reads page fields; override with
 * $playlist_* variables before include.
 *
...
?>
<section class="playlist" x-data="{ shown: false }" x-intersect:enter.threshold.0.2="shown = true">
    <div class="wrap">
        <div class="playlist-header">
            <svg class="playlist-note playlist-note-1" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg>
            <?php if ( $playlist_title ) : ?>
                <h2 class="heading-3 playlist-title" data-animate="fade-up" :class="shown && 'is-visible'"><?php echo wp_kses_post( $playlist_title ); ?></h2>
            <?php endif; ?>
            <svg class="playlist-note playlist-note-2" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M9 18V5l12-2v13"></path><circle cx="6" cy="18" r="3"></circle><circle cx="18" cy="16" r="3"></circle></svg>
        </div>
        <div class="playlist-links" data-animate="fade-up" data-animate-delay="1" :class="shown && 'is-visible'">
            <?php if ( $spotify_link ) : ?>
                <a class="playlist-link" href="<?php echo esc_url( $spotify_link['url'] ); ?>"<?php echo ! empty( $spotify_link['target'] ) ? ' target="' . esc_attr( $spotify_link['target'] ) . '"' : ''; ?>>
